define(function (require) {
    ...
    var Backbone            = require('backbone'),
        ...
        EventCollection = Backbone.Collection.extend({
            ...
            url: function(){
                    if(in_browser===false){
                        return 'https://www.google.com/calendar/feeds/libertiescollege.dublin@gmail.com/public/full?orderby=starttime&sortorder=ascending&max-results=10&futureevents=true';
                    }
                    else{
